...
import com.atguigu.mapper.ManagerSearchMapper;
...
public class ManagerSearchServiceImpl implements ManagerSearchService {
    ...
    @Autowired
    private ManagerSearchMapper searchMapper;
    @Autowired
    ...
    public List<OBJECT_T_MALL_SKU_MANAGER> search_sku_by_class_2(int class_2_id){
        return searchMapper.select_sku_by_class_2(class_2_id);
    }

    @Override
    public List<OBJECT_T_MALL_SKU_MANAGER> search_sku_by_attr(int class_2_id, List<T_MALL_SKU_ATTR_VALUE> list_av,String order) {
        ...
        List<OBJECT_T_MALL_SKU_MANAGER> skus = searchMapper.select_sku_by_attr(map);
        return skus;
    }
